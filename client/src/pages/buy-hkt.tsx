    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">Buy HKT Tokens</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300">Start your property investment journey today</p>
        </div>
